...
var CartModel = /** @class */ (function () {
    ...
    CartModel.deleteProduct = function (id, productPrice) {
        fs_1["default"].readFile(p, function (err, fileContent) {
            ...
            var updatedProduct = cart.products.filter(function (prod) { return prod.id !== id; });
            var updatedPrice = cart.totalPrice - Number(productPrice);
            var updatedCart = { updatedProduct: updatedProduct, updatedPrice: updatedPrice };
