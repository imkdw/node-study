...
adminRouter.post("/add-product", is_auth_1.isAuth, [
    (0, express_validator_1.body)("title").isString().isLength({ min: 3 }).trim().withMessage("Title must be least 3 letters"),
...
adminRouter.get("/products", is_auth_1.isAuth, admin_1["default"].getProducts);
